...
export type MeasurePeriodicity =
  | "month"
  | "annual"
  | "none"
  | "rolling_proxy"
...
export const MEASURE_CATALOG: readonly MeasureMetadata[] = [
  ...
  {
    id: MEASURE_ID.FORECAST_MONTHS_TO_TARGET,
    semanticMode: "forecast.targets.months_to_workbook",
    label: "Months to workbook target",
    labelKey: "labels.forecastMonthsToTarget",
    descriptionKey: "registry.forecastMonthsToTarget",
    unit: "count",
    format: "integer",
    periodicity: "forward_horizon",
    dependsOn: [MEASURE_ID.WORKBOOK_SALES_TARGET, MEASURE_ID.REVENUE_SCENARIO_MONTHLY],
    sourceEngine: "derived",
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["evaluateForwardForecast", "targets.monthsToTarget"],
  },
  {
    id: MEASURE_ID.FORECAST_MARGIN_TREND_PCT,
    semanticMode: "forecast.financial.margin_trend",
    label: "NP% trend (horizon)",
    labelKey: "labels.forecastMarginTrend",
    descriptionKey: "registry.forecastMarginTrend",
    unit: "none",
    format: "decimal",
    periodicity: "forward_horizon",
    dependsOn: [MEASURE_ID.NP_PCT_SCENARIO],
    sourceEngine: "derived",
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["evaluateForwardForecast", "financial.marginTrendPct"],
  },
  {
    id: MEASURE_ID.FORECAST_END_REVENUE,
    semanticMode: "forecast.financial.end_revenue",
    label: "Horizon-end revenue",
    labelKey: "labels.forecastEndRevenue",
    descriptionKey: "registry.forecastEndRevenue",
    unit: "currency_monthly",
    format: "currency",
    periodicity: "forward_horizon",
    dependsOn: [MEASURE_ID.REVENUE_SCENARIO_MONTHLY],
    ...
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["evaluateForwardForecast", "financial.points[last].revenue"],
  },
  {
    id: MEASURE_ID.FORECAST_TARGET_ATTAINMENT_PCT,
    semanticMode: "forecast.targets.attainment",
    label: "Workbook target attainment",
    labelKey: "labels.forecastTargetAttainment",
    descriptionKey: "registry.forecastTargetAttainment",
    unit: "ratio",
    format: "pct",
    periodicity: "forward_horizon",
    dependsOn: [MEASURE_ID.WORKBOOK_SALES_TARGET],
    sourceEngine: "derived",
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["evaluateForwardForecast", "targets.attainmentPct"],
  },
  {
    id: MEASURE_ID.FORECAST_FIRST_SATURATION_MONTH,
    semanticMode: "forecast.operational.saturation",
    label: "First saturation month",
    labelKey: "labels.forecastSaturation",
    descriptionKey: "registry.forecastSaturation",
    unit: "none",
    format: "integer",
    periodicity: "forward_horizon",
    dependsOn: [MEASURE_ID.OPERATIONAL_UTILIZATION_PCT],
    sourceEngine: "derived",
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["evaluateForwardForecast", "operational.firstSaturationMonth"],
  },
  {
  ...
  {
    id: MEASURE_ID.OPERATIONAL_UTILIZATION_PCT,
    semanticMode: "operational.utilization_pct",
    label: "Delivery utilization",
    labelKey: "labels.operationalUtilization",
    descriptionKey: "registry.operationalUtilization",
    unit: "ratio",
    format: "pct",
    periodicity: "month",
    dependsOn: [MEASURE_ID.OPERATIONAL_DEMAND_HOURS, MEASURE_ID.OPERATIONAL_SUPPLY_HOURS],
    sourceEngine: "derived",
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["evaluateOperationalFeasibility", "demand ÷ supply"],
  },
  {
    id: MEASURE_ID.OPERATIONAL_DEMAND_HOURS,
    semanticMode: "operational.demand_hours",
    label: "Implied demand hours",
    labelKey: "labels.operationalDemandHours",
    descriptionKey: "registry.operationalDemandHours",
    unit: "none",
    format: "decimal",
    periodicity: "month",
    dependsOn: [],
    ...
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["deriveScenarioDemand", "revenue × levers proxy"],
  },
  {
    id: MEASURE_ID.OPERATIONAL_SUPPLY_HOURS,
    semanticMode: "operational.supply_hours",
    label: "Billable supply hours",
    labelKey: "labels.operationalSupplyHours",
    descriptionKey: "registry.operationalSupplyHours",
    unit: "none",
    format: "decimal",
    periodicity: "month",
    dependsOn: [],
    ...
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["deriveHrWorkforceModel", "BU billable hours/month"],
  },
  {
    id: MEASURE_ID.OPERATIONAL_HIRING_FTE_GAP,
    semanticMode: "operational.hiring_fte_gap",
    label: "Hiring pressure (FTE)",
    labelKey: "labels.operationalHiringFte",
    descriptionKey: "registry.operationalHiringFte",
    unit: "none",
    format: "decimal",
    periodicity: "month",
    dependsOn: [MEASURE_ID.OPERATIONAL_DEMAND_HOURS, MEASURE_ID.OPERATIONAL_SUPPLY_HOURS],
    ...
    category: "diagnostic",
    visibility: "executive",
    calculationPath: ["evaluateOperationalFeasibility", "deficit hours ÷ standard FTE month"],
  },
  {
  ...
  {
    id: MEASURE_ID.INCENTIVE_POOL_COMPANY_TOTAL,
    semanticMode: "incentive.pool.company_total_sar",
    label: "Incentive pool (company total)",
    labelKey: "labels.incentivePoolTotal",
    descriptionKey: "registry.incentivePoolTotal",
    unit: "sar_annual",
    format: "currency",
    periodicity: "annual",
    dependsOn: [],
    ...
    category: "diagnostic",
    visibility: "both",
    calculationPath: ["evaluateIncentiveRun", "companyTotalSar after layers and caps"],
  },
  {
    id: MEASURE_ID.INCENTIVE_POOL_RETAINED,
    semanticMode: "incentive.pool.retained_sar",
    label: "Company retained (incentives)",
    labelKey: "labels.incentivePoolRetained",
    descriptionKey: "registry.incentivePoolRetained",
    unit: "sar_annual",
    format: "currency",
    periodicity: "annual",
    dependsOn: [MEASURE_ID.INCENTIVE_POOL_COMPANY_TOTAL],
    sourceEngine: "derived",
    category: "diagnostic",
    visibility: "both",
    calculationPath: ["evaluateIncentiveRun", "companyRetainedSar after reserve and pool"],
  },
] as const;
